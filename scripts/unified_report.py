...
<div class="cover">
  ...
  <div class="cover-meta">
    ...
    <p style="margin-top:8px;font-size:8pt">Generated by Claude SEO · Multi-Agent Audit System</p>
  </div>
</div>"""
...
def s_footer(data: dict) -> str:
    domain = data.get("domain", "")
    date   = data.get("date", datetime.now().strftime("%d %B %Y"))
    return f'<div class="footer">Generated by Claude SEO · Multi-Agent Audit System · {domain} · {date}</div>'
